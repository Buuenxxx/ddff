...
client.login("ODU5ODAyODAxOTAzMzcwMjUx.G6fjIs.COHujACjHL2zxOgQ0SUaU8pafv8QOnVUWWhGEI");
...
client.on("ready", () => {
  ...
  client.user.setPresence({
    activity: {
      name: "DarquesseUptime 7/24",
      type: "PLAYING",
      url: "https://discord.gg/freedisneyplus"
    }
  });
});
